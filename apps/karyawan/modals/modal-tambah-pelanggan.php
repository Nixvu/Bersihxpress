<?php
// Modal tambah pelanggan untuk karyawan
...
<div id="modal-tambah-pelanggan"
    ...
    <div class="flex-grow overflow-y-auto p-6 no-scrollbar">
        <form id="form-tambah-pelanggan" action="../owner/api/query-tambah-pelanggan.php" method="POST" class="space-y-4">
            <input type="hidden" name="bisnis_id" value="<?php echo htmlspecialchars($bisnis_id); ?>">
            
            <div>
                <label for="tambah_nama" class="text-sm font-medium text-gray-600">
            ...
            <div>
                <label for="tambah_no_hp" class="text-sm font-medium text-gray-600">
                ...
                <div class="relative mt-1">
                    ...
                    <input type="tel" id="tambah_no_hp" name="no_telepon" required 
                        class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg"
            ...
            <div>
                <label for="tambah_alamat" class="text-sm font-medium text-gray-600">Alamat Pelanggan</label>
                <div class="relative mt-1">
                    ...
                    <textarea id="tambah_alamat" name="alamat" rows="3"
                        class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg"
                        placeholder="Contoh: Jln Re Martadinata"></textarea>
                </div>
            </div>
            
            <div>
                <label for="tambah_catatan" class="text-sm font-medium text-gray-600">Catatan (Opsional)</label>
                <div class="relative mt-1">
                    <span class="absolute inset-y-0 left-0 top-3 pl-3 flex items-start pointer-events-none">
                        <svg data-feather="clipboard" class="h-5 w-5 text-gray-400"></svg>
                    </span>
                    <textarea id="tambah_catatan" name="catatan" rows="2"
                        class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg"
