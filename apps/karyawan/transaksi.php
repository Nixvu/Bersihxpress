...
require_once 'api/query-transaksi.php';
...
<body class="bg-gray-100 flex flex-col h-screen">
    ...
    <div id="modal-container" class="hidden z-30">
        ...
        <?php include __DIR__ . '/modals/modal-crud-transaksi.php'; ?>

        <!-- WhatsApp Modal (copy from owner, adapted for karyawan) -->
        <div id="modal-kirim-wa" class="modal-popup hidden fixed bottom-0 left-0 right-0 bg-white rounded-t-[24px] shadow-2xl z-50 flex flex-col h-auto">
            ...
            <div class="px-6 pb-4">
                ...
                <input type="tel" id="wa-phone-input" class="w-full px-3 py-3 border border-gray-300 rounded-lg mb-4" placeholder="08xxxxxxxxxx">
                ...
                <select id="wa-template-select" class="w-full px-3 py-3 border border-gray-300 rounded-lg mb-4">
                    ...
                    foreach ($labels as $jenis => $label) {
                        echo '<option value="' . $jenis . '">' . $label . '</option>';
                    }
                    ?>
                </select>
